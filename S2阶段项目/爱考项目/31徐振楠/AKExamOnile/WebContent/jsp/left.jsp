...
// 		根据登录用户级别显示不同的功能
		...
		case 1:
	        ...
	        outlookbar.additem('在线考试', t, '../exam/exam_getPapersByInfo?up=1');
	        outlookbar.additem('笔试成绩', t, '../scores/scores_getScoresList?up=1');
		...
		case 2:
	        ...
	        outlookbar.additem('题库管理', t, 'questions/questionlist.jsp'); 
			outlookbar.additem('试卷管理', t, '');
	        outlookbar.additem('成绩管理', t, '../scores/scores_getPapersByInfo?up=1');
	        outlookbar.additem('修改密码', t, '');
			break;
		case 4:
			t = outlookbar.addtitle('后台功能', '后台管理', 1);
	        outlookbar.additem('教师信息', t, '');
	        outlookbar.additem('班级信息', t, '');
	        outlookbar.additem('学生信息', t, '');
	        outlookbar.additem('题库管理', t, 'questions/questionlist.jsp'); 
			outlookbar.additem('试卷管理', t, '../paper/paper_getPaperByInfo?up=1');
	        outlookbar.additem('成绩管理', t, '../scores/scores_getPapersByInfo?up=1');
	        outlookbar.additem('修改密码', t, '');
...
<body onload="initinav('后台管理');">
	<div id="left_content">
		<div id="user_info">
			欢迎您，<strong>${user.student.sname=='未知'||user.name=='admin'?user.name:user.student.sname}</strong>
		</div>
		<div id="main_nav">
